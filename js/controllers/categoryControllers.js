...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    loadCategories(); //Después de cargar las constantes, se cargan los registros.
        ...
        async function loadCategories(){
            try{
                ...
                categories.forEach((cat)=> {
                    //Creamos una fila POR CADA elemento encontrado
                    ...
                    tr.innerHTML = `
                        ...
                        <td><button class="btn btn-sm btn-outline-secondary edit-btn">
                    ...
                    //Agregamos funcionalidad para el boton de editar categorías
                    ...
                    tr.querySelector(".delete-btn").addEventListener("click", async ()=>{
                        if(confirm("¿Desesa eliminar categoria?")){
